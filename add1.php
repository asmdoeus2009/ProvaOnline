...
<div class="card-header"> <h5 class="title">Adicionar atividade</h5>  <table width="200" border="0">
...
<button type="submit" class="btn btn-primary pull-right" name="submit">Criar Prova</button>

...
<input type="text" name="cpf" maxlength="11" class="form-control" required placeholder="Digite o seu cpf">
</div>
</div>
<!-- Conteúdo  a baico -->
<?php require('provas/primeiro.php');?> 
<!-- Conteúdo a  baico -->
<div class="col-md-12">
<div class="form-group">
<input type="submit" name="grupo1_btn"  class="btn btn-fill btn-primary" value="Finalizar">
</div>
</div>
</div>
</div>
...
</div><?php require('provas/segundo.php');?> 
<!-- Conteúdo a  baico -->
...
<?php require('provas/terceiro.php');?>
<!-- Conteúdo a  baico -->
<div class="col-md-12">
<div class="form-group">
...
<?php require('provas/quinto.php');?> 
 <!-- Conteúdo a baico -->
<div class="col-md-12">
<div class="form-group">
<input type="submit" name="grupo5_btn"  class="btn btn-fill btn-primary" value="Finalizar">
</div>
</div> 
</div>
</div>

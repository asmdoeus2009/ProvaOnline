...
$result_usuario = "SELECT * FROM andressap ORDER BY Id DESC LIMIT $inicio, $qnt_result_pg";
...
$user = 'root';//Usuario
$pass = '';//Senha
$db = 'escolar';//Nome do banco de dados
...
?></h4>
	...
	$result_pg = "SELECT COUNT(id) AS num_result FROM andressap";

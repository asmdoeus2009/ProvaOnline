...
$ret=mysqli_query($con,"SELECT month(datahora) as rptmonth,year(datahora) as rptyear,SUM(ExpenseCost) as totalmonth FROM tblexpense  where (datahora BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by month(datahora),year(datahora)");
$cnt=1;

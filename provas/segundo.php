...
<label style="color:#FBF7F7;font-size:15px;font-family:calibri ;"><input type="radio" name="resposta_19" value="<?php  echo $row['pergunta_41'];?>" required />&nbsp;<?php  echo $row['pergunta_40'];?> </label> <BR />
...
<button type="submit"  name="grupo2_btn" class="btn btn-primary pull-right">Finalizar</button>
</div>
</div>
    <?php } ?>
...
<div class="col-md-12">
<div class="form-group">
<label><h5><p class="text-danger"><?php  echo $row['pergunta_19'];?></p></h5>  </label><br>
...
<button type="submit"  name="grupo3_btn" class="btn btn-primary pull-right">Finalizar</button>
</div>
</div>

...
$tdate=date('Y-m-d');
$query=mysqli_query($con,"select sum(ExpenseCost)  as todaysexpense from tblexpense, erika where (ExpenseDate)='$tdate' && (UserId='$userid');");
...
echo $sum_total_expense;
	...
	<center><?php include_once('includes/footer.php');?>

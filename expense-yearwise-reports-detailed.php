...
$ret=mysqli_query($con,"SELECT year(datahora) as rptyear,SUM(ExpenseCost) as totalyear FROM tblexpense  where (datahora BETWEEN '$fdate' and '$tdate') && (UserId='$userid') group by year(datahora)");
$cnt=1;

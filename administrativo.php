...
function mostrar_abas(obj) {
  ...
  <div class="sidebar">
   ...
   <div class="sidebar-wrapper">
    ...
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" style="width: 200px; font-size: 15px; " >Material</a>
    <div class="dropdown-menu">
      <a class="dropdown-item" href="#" onclick="mostrar_abas(this);" id="mostra_aba1">Português</a>
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="#" onclick="mostrar_abas(this);" id="mostra_aba2">Matemática </a>
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="#" onclick="mostrar_abas(this);" id="mostra_aba3">Ciências</a>
      <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="#" onclick="mostrar_abas(this);" id="mostra_aba4">Historia</a>
        <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="#" onclick="mostrar_abas(this);" id="mostra_aba5">Geografia</a>
        <div class="dropdown-divider"></div>
      <a class="dropdown-item" href="#" onclick="mostrar_abas(this);" id="mostra_aba6">Inglês</a>
    </div>
  </li>
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu dropdown-navbar">
                  ...
                  <li class="nav-link"><a class="nav-item dropdown-item"href="index.php?logout='1'" style="color: red;">Log out</a> </li>
                </ul>
              </li>
...
<div id="div_aba1" style="display:none;">1
</div> 

<div id="div_aba2" style="display:none;">2
</div>

<div id="div_aba3" style="display:none;">3
</div>

<div id="div_aba4" style="display:none;">4
</div>

<div id="div_aba5" style="display:none;">5
</div> 

<div id="div_aba6" style="display:none;">6
</div>
    ...
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <a href="#" target="_blank" class="btn btn-round btn-info"><i class="fab fa-facebook-f"></i> &middot; 0</a>
          ...
          <br>
          <br>
          Bem vindo,<a class="navbar-brand" href="javascript:void(0)">&nbsp;&nbsp; <i  style="color: #888;"><?php   echo "". $_SESSION['usuarioNome']; ?> </i> </a>
        </li>
      </ul>
    </div>
  </div>
